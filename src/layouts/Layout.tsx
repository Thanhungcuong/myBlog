                        ...
                        <div className="flex space-x-8 items-center">
                            {user && (
                                <li className="relative" ref={dropdownNoti}>
                                    ...
                                    />
                                    {showNotifications && (
                                        <div className="absolute right-0 z-50 mt-2 bg-slate-100 w-80 shadow-lg rounded-lg overflow-hidden p-4">
                                            <p className='w-fit text-xl font-bold mx-auto '>Thông báo</p>
